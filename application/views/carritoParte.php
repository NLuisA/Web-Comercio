<body id="fondocarritoPate">
<div class="container-fluid" id="carrito">
    <div class="cart" >
        <div class = "heading">
            <h2 id="h2" align="center" style="color: yellow;">Productos en tu Carrito</h2>
        </div>

        <div class="text" align="center" style="color: yellow;">
        ...
        <table class="table" border="0" cellpadding="5px" cellspacing="1px">
            ...
            ?>
                <tr id= "main_heading" style="color: yellow;" >
                    <td>ID</td>
                    <td>Descripcion</td>
                    <td>Precio</td>
                    <td>Cantidad</td>
                    ...
                    <tr style="color: white;" >
                        ...
                        <td>
                            <?php echo form_input('cart[' . $item['id'] . '][qty]', $item['qty'] ,
                                                    'maxlength="3" size="1" type="number" style="text-align: right"'); ?>
                        </td>
                        ...
                        <td>
                            <?php // Imagen 
                                $path = '<img src= '. base_url('assets/img/icons/basura.png') . ' width="25px" height="20px">';
                ...
                <tr>
                    ...
                    <td colspan="5" align="right">
                        <!-- Borrar carrito usa mensaje de confirmacion javascript implementado en partes/head_view -->
                         <input style="background: #C80014;" type="button" class ='btn btn-primary btn-lg' value="Borrar carrito"  onclick=" borrar_carrito()">
                        <!-- Submit boton. Actualiza los datos en el carrito -->
                        <input style="background: #C80014;" type="submit" class ='btn btn-primary btn-lg' value="Actualizar"onclick="actualizar()">
                        <!-- " Confirmar orden envia a carrito_controller/muestra_compra  -->
                        <input style="background: #C80014;" type="button" class ='btn btn-primary btn-lg' value="Confirmar Orden" onclick="window.location = 'comprar'">
                    </td>
                </tr>
                <?php echo form_close();
            endif; ?>
